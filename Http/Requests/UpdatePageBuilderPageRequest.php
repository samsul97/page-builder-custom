...
class UpdatePageBuilderPageRequest extends FormRequest
{
    ...
    {
        /** @var PageBuilderPage|null $page */
        $page = $this->route('pageBuilderPage');

        return [
            'title' => ['required', 'string', 'max:190'],
            'slug' => ['required', 'string', 'max:190', Rule::unique('pb_pages', 'slug')->ignore($page?->id)],
